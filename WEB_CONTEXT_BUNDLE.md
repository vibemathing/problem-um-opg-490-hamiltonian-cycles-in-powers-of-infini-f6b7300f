...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-490"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-v1",
      "problem_contract_sha256": "d088b5c95f549338403ac9352dd4d05b4adb809f2f61f229ae243c2e2dd93863",
      "problem_id": "problem:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f",
      "route_id": "route:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-source-fidelity-01",
      "graph_id": "graph:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture - If $G$ is a countable connected graph then its third power is hamiltonian. - If $G$ is a 2-connected countable graph then its square is hamiltonian."
          },
          "statement_sha256": "c7f1ae6f49527d554bc3b79dedeecddf33e56b4fb4bd339929612d3c5fd2b8b4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-root",
      "route_id": "route:um-opg-490-hamiltonian-cycles-in-powers-of-infini-f6b7300f-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-490-727c055b07f5",
        "url": "https://www.unsolvedmath.com/problems/OPG-490"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
